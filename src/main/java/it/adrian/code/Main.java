...
public class Main {
    ...
    public static void main(String... args) throws Exception {
        ...
        server.createContext("/api/decision", new HandlerLikesAndDislikes());//http://localhost:8000/api/decision?action=like&id=64036f7e907a420100c6a51f
        ...
        server.createContext("/api/getManLimitations", new HandlerGetLimitsForMan());//http://localhost:8000/api/getManLimitations
